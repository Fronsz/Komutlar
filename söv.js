...
exports.run = async (client, msg, args) => {
  let kufur=[
    ...
    "senin ananın amındaki kılları tek tek alır babanın kel kafasına yapıştırır sikerim",
    "senin ananın amına teletabinin antenlerini sokar göbeğinde ulusa porno yayını yaparım",
    "ananın amına çam ağacı sokar, gölgesinde sülaleni sikerim",
    "ananın amına yoğurt sürer sike sike ayran yaparım",
    "senin ananı yerde sikerim bidaha ayağa kalkamaz",
  ]
 ...
 color: Math.floor(Math.random() * (0xFFFFFF + 1)),
 description: (`:no_entry_sign: Hoop! Orda durucan Yapımcım !         ɌⱢ ↬ Fronsz#0001'ya sövemezsin.`)
}})
