...
module.exports.run = async (bot, message, args) => {
  ...
  if (args[0] === undefined) {
    ...
    if (args[1] === undefined) {
      ...
      if (!Langs.includes(transArg)) return message.channel.sendEmbed(new Discord.RichEmbed().setDescription(`Böyle bir dil yok. Dilleri Türkçe değil de İngilizce yaz. \nÖrnek\n :x: *çeviri ingilizce selam\n:white_check_mark: c!çeviri english selam\n\nUygun diller: ${Langs}`).setColor('RANDOM'));
      args = args.slice(transArg.length);

      translate(args, {to: transArg}).then(res => {

        const embed = new Discord.RichEmbed()
        .setTitle('Spickle\'s Çeviri', 'https://images-ext-2.discordapp.net/external/yBekOtLPO_4ukiht-bKCXh8pe4XH-n9ZjzM4PvBByNY/https/images.techhive.com/images/article/2017/05/pcw-translate-primary-100723319-orig.jpg')
